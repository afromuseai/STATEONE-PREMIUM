  ...
  async (req, res): Promise<void> => {
    ...
    try {
      ...
      try {
        ...
        // Flush BUILD phase complete — events generated by llm:codegen_complete bus emit above.
        // Engine subscriber: "Application structure ready..." + emitPhaseComplete("BUILD")
        flushEngine(engine, res);
      ...
      // Flush REPORT phase start — events generated by database:save_files running bus emit below.
