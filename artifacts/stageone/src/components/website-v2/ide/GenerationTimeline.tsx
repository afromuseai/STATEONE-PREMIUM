...
// Studio generation pipeline. It owns no session/context — consumers feed it
// events (see `GenerationEvent`) and it renders a calm, collaborative build
// log — not a wall of console output.
...
// Website Studio's own generation event bus. Aliased to avoid colliding with
// this file's pre-existing `GenerationEvent` /
...
// The generation pipeline can dispatch these events to drive the timeline.
// `applyGenerationEvent` below is a pure
