...
//   P6.3 — Shared AI Context (build session visible to team)
...
const DEMO_FEED: ActivityEvent[] = [
  {
    ...
    type: "ai",     message: "AI Builder rewrote HeroSection with gradient styles", time: "just now",
  },
  {
...
function SharedContext({ project }: { project: V2Project }) {
  ...
  const insights = [
    ...
    { icon: Brain,    label: "AI Builder context: active", color: "text-[#ECECEC]" },
  ...
  return (
    <div className="px-3 pb-3">
      ...
      <p className="mt-2 px-2 font-mono text-[9px] leading-relaxed text-[#ECECEC]/20">
        All collaborators share the same AI Builder context — edits, history, and project memory sync automatically.
      </p>
    </div>
  )
}
