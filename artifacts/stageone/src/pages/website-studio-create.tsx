...
//   2. Workspace — opens immediately on submit; the Website Studio agent streams
//      live into the AgentConversation side panel while files populate the editor
//      in real time. There is no separate "generating" screen. The workspace IS
//      the generation UI.
...
import {
  ...
  useWSSessionContext,
  useWSSessionStream,
} from "@/lib/website-studio-session/context"
...
// ─── Inner component — consumes the Website Studio session ──────────────────
function WebsiteStudioCreateInner() {
  const { state: session } = useWSSessionContext()
  ...
  // ─── Workspace — opens instantly, session streams into AgentConversation ───
  if (inWorkspace) {
        ...
        <div className="flex h-full w-full flex-col items-center justify-center bg-[#0e0e0e]">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-xs text-white/30">Your AI engineering team is starting your project</p>
            </div>
            <button
      ...
      <div className="flex h-full flex-col overflow-y-auto bg-[#0e0e0e]">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[11px] text-white/30">Describe your idea — your website is engineered live</p>
          </div>
        </motion.div>
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 py-16">
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3 pb-2">
              ...
              <div className="text-center">
                ...
                <p className="mt-1.5 text-sm text-white/35">
                  Describe your idea and the AI engine will write the entire codebase — live, in your workspace.
                </p>
              </div>
            </div>
            ...
            <div className={isWorking ? "ws-orbit-wrapper" : ""}>
              ...
              >
                <textarea
                  ...
                  placeholder={isWorking ? "Your website is being engineered…" : "Describe what you want to build…"}
                  disabled={isWorking}
                  rows={1}
            ...
            <p className="text-center text-[11px] leading-relaxed text-white/18">
              The workspace opens the moment you submit. The AI development system plans architecture, writes code, and tests every file
